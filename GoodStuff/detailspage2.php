                ...
                <div class="showcase-container">
                    ...
                    <div class="showcase">
                        ...
                        <div class="showcase-banner">
                            <img src="./assets/images/products/balkabagiturta.jpg" alt="shampoo, conditioner & facewash packs" class="showcase-img" , height="10">
                        </div>

                        <div class="showcase-content ">


                            <h1 class="showcase-title">BALKABAĞI TURTASI</h1>


                            <p class="showcase-desc">
                                Sonbaharın en güzel getirilerinden bal kabaklarında bugün söz sırası.

                                Zaten o kadar kısa bir süre bizimle oluyorlar ki hazır bol bol bulabiliyorken elimizden
                                geldiğince çok ve çeşitli şekilde değerlendirmeliyiz onu.

                                Hepimizin mutfağına en çok konuk olan hali klasik kabak tatlısı olsa da aslında onunla
                                daha farklı ve nefis neler yapılabilir, keşfetmenin tam zamanı şimdi!

                                Çok geç olmadan, bal kabaklarının tadını doya doya çıkaracağınız, hepsi pek süslü çok
                                lezzetli tatlılara bırakıyoruz sözü.

                                E artık seçin seçin yapın.
                            </p>
